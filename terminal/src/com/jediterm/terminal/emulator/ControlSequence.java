...
public class ControlSequence {
  ...
  boolean pushBackReordered(final TerminalDataStream channel) throws IOException {
  ...
  final void appendToBuffer(final StringBuilder sb) {
    sb.append("ESC[");
  ...
  boolean startsWithQuestionMark() {
    return myStartsWithQuestionMark;
  }

  boolean startsWithMoreMark() {
